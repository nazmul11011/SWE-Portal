...
import { uploadCgpaAction } from "@/app/courses/cgpaupdate/actions";
import {
  Table,
  TableBody,
  TableCell,
...
export default function UploadCgpaForm() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <p className="text-sm text-muted-foreground">The CSV file must contain these headers: regNo, cgpa, creditCompleted</p>
